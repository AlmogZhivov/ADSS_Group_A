...
public class ShiftDTO {
    ...
    public ShiftDTO(int id, String branch, LocalDateTime startTime, LocalDateTime endTime, Map<Integer, Integer> requiredRoles, List<String> availableWorkers, List<String> assignedWorkers, Map<String, Integer> workerRoles) {
        this.id = id;
        this.startTime = startTime;
        this.endTime = endTime;
        this.requiredRoles = requiredRoles;
